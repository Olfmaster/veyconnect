...
export default function Footer() {
  ...
  return (
    <footer className="bg-base text-fg-faint border-t border-line/10 px-6 md:px-10 py-16 text-sm">
      <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-3">
          <p className="label-mono text-fg-muted mb-4">Unternehmen</p>
          <ul className="space-y-2.5">
            <li><Link href="/partner" className="hover:text-fg transition-colors">Partner</Link></li>
            <li><Link href="/ueber-uns" className="hover:text-fg transition-colors">Über uns</Link></li>
            <li><Link href="/region" className="hover:text-fg transition-colors">Region</Link></li>
            <li><Link href="/faq" className="hover:text-fg transition-colors">FAQ</Link></li>
            <li><Link href="/kontakt" className="hover:text-fg transition-colors">Kontakt</Link></li>
          </ul>
        </div>

        <div className="md:col-span-2">
          <p className="label-mono text-fg-muted mb-4">Kontakt</p>
          <ul className="space-y-2.5">
            <li>
              <a href="mailto:info@veyconnect.de" className="hover:text-fg transition-colors">
                info@veyconnect.de
              </a>
            </li>
            <li>
              <a href="tel:+4917624596941" className="hover:text-fg transition-colors">
                +49 176 24596941
              </a>
            </li>
            <li className="text-fg-faint">Niederdorfelden · Rhein-Main</li>
            <li className="text-fg-faint text-xs pt-2 inline-flex items-center gap-2">
      ...
      <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-line/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-fg-faint">
